...
‎      const meterNumber = `MTR-${Date.now()}-${Math.random().toString(36).substr(2, 9).toUpperCase()}`;
‎      
‎      return {
‎        updateOne: {
...
‎    });
‎
‎    // Send notifications to customers (in production)
‎    // customers.forEach(customer => {
‎    //   sendMeterApprovalEmail(customer.email, customer.meterNumber);
‎    // });
‎
‎    return NextResponse.json({
